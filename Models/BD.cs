...
namespace TP11.Models
{
    ...
    {
        private static string _connectionString = @"Server=A-AMI-10; DataBase=BDWebCursos; Trusted_Connection=True";
        ...
        public static void AgregarCurso(Curso MiCurso){
            ...
            int variable=0;
            using(SqlConnection db = new SqlConnection(_connectionString)){
                variable = db.Execute(sql, new{ pNombre = MiCurso.Nombre, pDescripcion=MiCurso.Descripcion, pImagen = MiCurso.Imagen, pUrlCurso=MiCurso.UrlCurso, pIdEspecialidad=MiCurso.IdEspecialidad});
            }
        }
        ...
        public static void CalificarCurso(int IdCurso, bool Like){
            ...
            using(SqlConnection db = new SqlConnection(_connectionString)){
                variable = db.Execute(sql, new{pIdCurso=IdCurso});
            }
        }
